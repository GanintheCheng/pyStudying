...
if __name__ == "__main__":
    ...
    # 3. 按时间顺序划分原始数据
    # ==================================================
    train_series = series[:72]      # 前 60%
    val_series = series[72:96]      # 中间 20%
    test_series = series[96:]       # 最后 20%
