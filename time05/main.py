...
if __name__ == "__main__":
    ...
    # ==================================================
    # 10. RNN 模型与 Last Value Baseline 预测
    # ==================================================
    model.eval()

    with torch.no_grad():
        rnn_prediction_scaled = model(X_test)
    ...
    # 11. 反标准化
    # ==================================================
    rnn_prediction_original = inverse_standardize(
        rnn_prediction_scaled,
        train_mean,
        train_std,
    )
    ...
    for index in range(show_count):
        ...
        print(
            "RNN 模型预测：",
            rnn_prediction_original[index].squeeze(-1).tolist(),
        )
    ...
    rnn_values = rnn_prediction_original.reshape(-1).numpy()
